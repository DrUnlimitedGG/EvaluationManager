...
script.Parent.MouseButton1Click:Connect(function()
	...
	if p4 then
		...
		local panel = script.Parent.Parent.Parent.Parent.QuizPanel.Inside.ScrollingFrame
		
		exportString = exportString .. panel.Question1.Text .. "\n> '" .. panel.Answer1.Text .. "'\n"
		exportString = exportString .. panel.Question2.Text .. "\n> '" .. panel.Answer2.Text .. "'\n"
		exportString = exportString .. panel.Question3.Text .. "\n> '" .. panel.Answer3.Text .. "'\n"
		exportString = exportString .. panel.Question4.Text .. "\n> '" .. panel.Answer4.Text .. "'\n"
		exportString = exportString .. panel.Question5.Text .. "\n> '" .. panel.Answer5.Text .. "'\n"
		exportString = exportString .. panel.Question6.Text .. "\n> '" .. panel.Answer6.Text .. "'\n"
		exportString = exportString .. panel.Question7.Text .. "\n> '" .. panel.Answer7.Text .. "'\n"
		exportString = exportString .. panel.Question8.Text .. "\n> '" .. panel.Answer8.Text .. "'"
